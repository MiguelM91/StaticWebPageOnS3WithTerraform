...
resource "aws_s3_bucket_ownership_controls" "mybucketcontrols" {
...
resource "aws_s3_bucket_acl" "mybucketacl" {
  depends_on = [
    aws_s3_bucket_ownership_controls.mybucketcontrols,
...
resource "aws_s3_bucket_website_configuration" "mybucketwebconfig" {
    bucket = aws_s3_bucket.mybucket.id
